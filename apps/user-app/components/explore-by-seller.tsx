            ...
            return (
              ...
              >
                ...
                <div className="w-[39.375rem] h-[58.1875rem] flex flex-col items-center gap-[1rem] shrink-0 bg-[#fff] rounded-[1.8rem]">
                  ...
                  <div className="w-[90%] flex flex-col px-[1rem] leading-[2.3rem]">
                    {/* Nursery Name */}
                    ...
                    <div className="w-max flex gap-[1.5rem] items-center text-[1.1875rem] font-medium text-[#123524A1] text-center">
                      ...
                      {/* address */}
                      <div className="min-w-[15rem] max-w-max flex items-center gap-[10px]">
                  ...
                  {/* Nursery Description */}
                  <div className="w-[90%] text-[#606060] text-[1.22669rem] text-justify font-medium px-[1rem]">
                    {item.nurseryBio}
                  </div>

                  {/* Specialties */}
                  <div className="flex flex-wrap items-center  gap-[1rem] px-[2.4rem] mt-[1rem] h-max w-[40rem]">
                  ...
                  <div className="w-[90%] mt-[0.5rem] flex  gap-[2rem] px-[1rem] text-[#606060] text-[1.22669rem] font-normal">
                    <div className="flex items-center gap-[1rem]">
                      ...
                      <p className="w-[15rem]">{item.businesshours}</p>
                    </div>
                  ...
                  <div className="w-[90%] flex justify-between font-[Poppins] mt-[2rem]">
                    ...
                    {/* Button two */}
                    <button
                      className={`w-[11.6875rem] h-[4.0625rem] rounded-[5.25rem] border-[1.6px] border-[#56A430] bg-[#fff] flex justify-center items-center gap-[0.5rem] text-[#56A430] uppercase font-medium ${item.location==="" || item.location==="Not available yet" ? "cursor-not-allowed" : "cursor-pointer"}`}
                    >
                      <div className="relative w-[1.5rem] h-[1.5rem]">
                        <Image
                          alt="location"
