...
export const MobileNavBar = () => {
  ...
  if (displayMobileNavbar) {
    return (
      <div className="absolute z-50 new-sm:flex md:hidden bg-transparent w-screen h-screen justify-end py-[3.8rem] font-[Poppins]">
        <div className="w-[98%] h-[93%] flex flex-col items-end border-l-[1.6px] border-t-[1.6px] border-b-[1.6px] border-[#56A430] rounded-l-[1.5625rem] bg-[#FFFFFF]">
          {/* Cancle Icon */}
          <button
