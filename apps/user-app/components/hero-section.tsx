export const HeroSection = () => {
  return (
    <div className="new-sm: lg:w-[60rem] xl:w-[70rem] 2xl:w-[82.1875rem] min-h-[29rem] mt-[1rem] relative  overflow-hidden flex flex-wrap rounded-[28px]">
      <div className="polygon bg-[rgb(157,179,117)] w-[100%] h-[100%] border-[1px] border-[#9DB375]">
