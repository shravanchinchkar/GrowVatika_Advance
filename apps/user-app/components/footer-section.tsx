  ...
  return (
    ...
    >
      ...
      <div className="new-sm:w-[100%] new-sm-1:w-[29rem] md:h-[100%] new-sm:pt-[0.2rem] new-sm-1:pt-[2.5rem] lg:pt-[2.5rem]">
        ...
        <div className="relative new-sm:w-[4.5rem] new-sm-1:w-[15rem] lg:w-[15rem] xl:w-[20rem] new-sm:h-[4.5rem] new-sm-1:h-[15rem] lg:h-[15rem] xl:h-[20rem] new-sm:hidden md:flex items-start ml-[-1rem] lg:mt-[3rem] xl:mt-[2.5rem] drop-shadow-2xl">
          <Image
      ...
      <div className="new-sm:w-[100%] md:w-[66rem]">
        <div className="grid grid-cols-3 new-sm:pt-0 md:pt-[3rem] font-[Poppins] new-sm:border-b-[0.01675rem] md:border-b-[2px] border-[#123524] new-sm:pb-[0.5rem] md:pb-[2rem] xl:pb-[3rem]">
          ...
          <div className="new-sm:w-[90%] md:w-max  flex flex-col new-sm:gap-[0.2rem] new-sm-1:gap-[1rem] justify-self-center">
            ...
            <div className="text-[#123524A0] new-sm:text-[0.5rem] md:text-[0.8rem] xl:text-[1.25rem] font-medium uppercase flex flex-col new-sm:gap-[0.1rem] new-sm-1:gap-[0.2rem]">
              <p>Testimonials</p>
          ...
          <div className="new-sm:w-[90%] md:w-max flex flex-col new-sm:gap-[0.2rem] new-sm-1:gap-[1rem]">
            ...
            <div className="text-[#123524A0] new-sm:text-[0.5rem] new-sm-1:text-[0.8rem] lg:text-[0.8rem] xl:text-[1.25rem] font-medium uppercase flex flex-col new-sm:gap-[0.1rem] new-sm-1:gap-[0.2rem]">
              <p>product lists</p>
              <p>return & exchange</p>
              <p>order</p>
            </div>
          ...
          <div className="new-sm:w-[90%] md:w-max lg:ml-[2rem] xl:ml-0 flex flex-col new-sm:gap-[1rem] new-sm-1:gap-[4rem]">
            <div className="flex flex-col new-sm:gap-[0.2rem] new-sm-1:gap-[1rem]">
              <div className="new-sm:text-[0.7rem]  md:text-[1.2rem] xl:text-[1.5rem] text-[#123524] font-bold uppercase">
                Contact us
              </div>

              <div className="text-[#123524A0] new-sm:text-[0.5rem] new-sm-1:text-[0.8rem] lg:text-[0.8rem] xl:text-[1.25rem] font-medium flex flex-col new-sm:gap-[0.1rem] new-sm-1:gap-[0.7rem] gap-[0.7rem]">
            ...
            <div className="flex new-sm:gap-[0.5rem] new-sm-1:gap-[1rem]">
        ...
        <div className="font-[Poppins] flex justify-between text-[#3E7B27] uppercase">
          <div className="flex new-sm:gap-[0.5rem] new-sm-1:gap-[1rem] font-medium w-max new-sm:ml-[0.5rem] new-sm-1:ml-[2rem] new-sm:mt-[0.25rem] new-sm-1:mt-[1rem]">
            <div className="new-sm:text-[0.5rem] md:text-[0.8rem] xl:text-[1rem] new-sm:border-r-[0.1px] new-sm-1:border-r-[2px] border-black new-sm:pr-[0.5rem] new-sm-1:pr-[1rem]">
              2025@Company.Ltd
            </div>
          ...
          <div className="flex new-sm:gap-[1rem] new-sm-1:gap-[2rem] new-sm:mr-[1rem] new-sm-1:mr-[4rem] new-sm:mt-[0.25rem] new-sm-1:mt-[1rem] new-sm:text-[0.5rem] md:text-[0.8rem] xl:text-[0.9375rem] font-medium">
            <div>FAQ's</div>
            <div>Privacy</div>
          </div>
        </div>
