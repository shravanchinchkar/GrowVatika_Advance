...
export const SellerHeaderSection = () => {
  return (
    <div className="w-[90%] lg:h-[17rem] xl:h-[17rem] new-xl:h-[18rem] 2xl:h-[20rem] border-[2px] mt-[1rem] rounded-[2.5rem] border-[#12352433] flex flex-col justify-between shadow-seller-header-custom">
      <SellerNavbar />
