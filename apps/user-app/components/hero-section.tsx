...
export const HeroSection = () => {
  return ( 
    <div className="2xl:w-[82.1875rem] lg:w-[60rem] xl:w-[70rem] min-h-[29rem] mt-[1rem] relative  overflow-hidden flex flex-wrap rounded-[28px]">
      ...
      <div className="polygon bg-[#9DB375] w-[100%] h-[100%] border-[1px] border-[#9DB375]">
        ...
        <div className="lg:w-[16rem] xl:w-[22rem] 2xl:w-[24rem] lg:leading-[25px]  xl:leading-[29px] lg:mx-[2rem] 2xl:mx-[3rem] lg:mt-[1rem] 2xl:mt-[2rem] font-[Poppins] lg:text-[0.8rem] xl:text-[1rem] text-white">
          Welcome to <span className="font-bold italic">GrowVatika</span>, your one-stop destination to explore and shop
          from the best nurseries near you. Whether you're a plant lover, a home
          gardener, or a business looking for fresh greenery, find everything
          you need from multiple trusted sellers—all in one place!
        </div>
