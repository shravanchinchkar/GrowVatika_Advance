...
export const SellerHeaderSection = () => {
  return (
    <div className="w-[82.1875rem] h-[20rem] border-[2px] mt-[1rem] rounded-[2.5rem] border-[#12352433] pt-[2rem] flex flex-col justify-start gap-[2rem] shadow-seller-header-custom">
      <SellerNavbar />
