...
export const Header = () => {
  return (
    <div className="2xl:w-[82.1875rem] lg:w-[60rem] xl:w-[70rem] h-max flex justify-between items-center">
      ...
      <div className="2xl:w-[58.3rem] xl:w-[50rem] lg:w-[40rem] h-[4.05rem] flex justify-between items-center">
        ...
        <div className="z-10 lg:w-[15rem] xl:w-[21.3rem] h-[3.05rem]">
          <ProductSearchBar UseType={SearchBarWorkType.PRODUCTSEARCH} placeholder="Find your Plants, Pots, Tools..." />
        </div>
      </div>
