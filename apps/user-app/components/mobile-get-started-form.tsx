...
export const MobileGetStartedForm = () => {
  ...
  return (
    <div className="w-screen min-h-screen mx-h-max absolute top-0 new-sm:block md:hidden flex items-center justify-center bg-[#00000040] font-[Poppins] p-[1rem]">
        ...
        <div className="w-[100%] h-[90%] flex flex-col gap-[1rem] items-center px-[1rem]">
          ...
          >
            ...
            <div className={"w-[100%] h-[3rem]"}>
              <AuthButton buttonName="Submit" type="submit" loading={loading} />
            </div>
          </form>
