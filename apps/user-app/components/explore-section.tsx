  ...
  return (
    <div className="new-sm:pb-[1.37rem] new-sm-1:pb-0 lg:mt-[12rem] xl:mt-[15rem] 2xl:mt-[8rem] bg-custom-gradient">
      ...
      <div className="flex flex-col justify-center items-center new-sm:mt-0 sm:mt-1 mt-[1rem] font-[Poppins]">
        ...
        <div className="new-sm:text-[1rem]  sm:text-[1.3rem] lg:text-[1.5rem] xl:text-[2.25rem] font-medium uppercase new-sm:w-[22rem] sm:w-max new-sm:h-[1.5rem] sm:h-[2rem] lg:h-[3.375rem] text-center text-[#123524] mt-[1rem]">
