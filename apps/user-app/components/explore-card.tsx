    ...
    >
      ...
      <div className="absolute inset-0 grid grid-cols-2 transform transition-transform duration-300 group-hover:-translate-y-full">
        <div className="bg-white new-sm:px-[0.7rem] new-sm:py-[0.5rem] new-sm-2:p-[0.6rem] lg:p-[0.5rem] xl:p-[1rem] flex flex-col justify-between">
          <div className="uppercase new-sm:text-[0.7rem] new-sm-2:text-[0.9rem] md:text-[16px] font-medium">
            {cardData.title}
          </div>
          <div>
      ...
      <div className="transform transition-transform duration-300 translate-y-full group-hover:translate-y-0 font-[Poppins] bg-[#123524B8] w-[100%] flex flex-col items-start lg:gap-0 xl:gap-[0.2rem]">
        <div className="new-sm:h-[2rem] md:h-[4rem] new-sm:px-[1.2rem] md:px-[2rem] new-sm:py-[0.5rem] md:py-[0.5rem] lg:py-[0.5rem] xl:py-[1rem] new-sm:text-[0.8rem] new-sm-2:text-[0.9rem] md:text-[1.22688rem] font-semibold text-white">
          {cardData.title}
        </div>

        <div className="text-[#CBD0D3] new-sm:text-[0.8rem] new-sm-2:text-[0.9rem] md:text-[1rem] font-normal w-[100%] flex flex-col">
          {cardData.onHover.map((item: string) => {
            return (
              <div
                key={uuidv4()}
                className="w-[100%] new-sm:h-[25px] new-sm-2:h-[32px] md:h-[40px] lg:h-[40px] xl:h-[40px] flex items-center new-sm:pl-[1.2rem] md:pl-[2rem] hover:bg-[#123524] hover:drop-shadow-lg"
              >
                {item}
              </div>
            );
