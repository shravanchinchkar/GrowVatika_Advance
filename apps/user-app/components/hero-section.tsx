export const HeroSection = () => {
  return (
    <div className="new-sm:w-[10rem] sm:h-[14.125rem] lg:w-[60rem] xl:w-[70rem] 2xl:w-[82.1875rem] min-h-[29rem] mt-[1rem] relative  overflow-hidden flex flex-wrap rounded-[28px]">
      <div className="polygon bg-[#9DB375] w-[100%] h-[100%] border-[1px] border-[#9DB375]">
        <div className="lg:w-[31rem] 2xl:w-[47rem] italic leading-[51px] lg:px-[2rem] 2xl:px-[3rem] pt-[2rem] font-[Unbounded] lg:text-[2.5rem]  2xl:text-[3.2rem] font-bold uppercase text-white">
