...
export const ExploreProductCatalogSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-[2rem] mt-[1.5rem]">
        <SearchSort />

        {/* Filter Section and Product Card */}
        <div className="z-0 flex justify-between new-sm:w-[100%] md:w-[82.1875rem] font-[Poppins] border">
          {/* Sidebar */}
          <ProductFilterSection />

          <div className="new-sm:w-[100%] md:w-[75%]">
