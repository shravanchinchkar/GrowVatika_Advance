    ...
    <button
      className={
        buttonName == "Shop Now"
          ...
          : "new-sm:w-[3.5rem] new-sm:h-[2rem] lg:w-[80px] xl:w-[120px] lg:h-[40px] xl:h-[55px] group border-[2px] hover:border-none rounded-[2.10294rem] bg-[#56A430] hover:bg-[#123524] new-sm:shadow-xl new-sm-1:shadow-button-custom-boxshadow backdrop-blur-[6.408869743347168px] text-[#FFF6F4] new-sm:text-[0.5rem] new-sm-1:text-[0.90538rem] hover:text-[1rem] font-[Poppins] font-normal hover:font-semibold uppercase"
      }
      onClick={onClick}
    >
