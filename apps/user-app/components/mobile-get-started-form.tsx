...
export const MobileGetStartedForm = () => {
  ...
  if (MCFormVisibility) {
    return (
      <div className="new-sm:block md:hidden w-[100%] h-[100vh] absolute z-20 top-0 flex items-center justify-center bg-[#00000040] font-[Poppins] p-[1rem] overflow-scroll">
