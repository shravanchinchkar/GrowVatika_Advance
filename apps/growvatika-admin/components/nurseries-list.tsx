...
export const NurseriesList = memo(
  ({ loading, error, setError, setLoading }: TNurseriesList) => {
    ...
    return (
      <div className="w-[95%] h-[80%] rounded-[1.25rem] flex flex-col grid-cols-[70%_15%_15%] font-poppins bg-[#FFFFFF] shadow-productcard-custom-boxShadow mb-[1rem] overflow-y-scroll">
        {/* Header */}
        <div className="w-[100%] flex border-b-[1px] border-[#0000001A]">
          <h1 className="w-[70%] p-[0.7rem] flex justify-center items-center text-[1.5rem] font-normal capitalize border-r-[1px] border-[#0000001A]">
            Nursery Details
          </h1>
          <h1 className="w-[15%] p-[0.7rem] flex justify-center items-center text-[1.5rem] font-normal capitalize border-r-[1px] border-[#0000001A]">
            Launch Nursery
          </h1>
          <h1 className="w-[15%] p-[0.7rem] flex justify-center items-center text-[1.5rem] font-normal capitalize">
            Stop Nursery
          </h1>
        </div>
        {/* Nursery Content*/}
          ...
          return (
            ...
            >
              ...
              <div className="w-[70%] min-h-[35%] max-h-max flex items-center justify-between pl-[1.5rem] py-[0.5rem] border-r-[1px] border-[#0000001A] cursor-pointer">
                ...
                {/* Nursery Details */}
                <div className="w-[80%] h-[100%] grid grid-cols-[25%_75%] text-[1.3rem]">
