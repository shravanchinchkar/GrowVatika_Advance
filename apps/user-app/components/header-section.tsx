...
export const HeaderSection = memo(
  ({ explore, explorebyseller, singleProduct,isExplore}: HeaderSectionProp) => {
    ...
    return (
      <div
        className={`new-sm:w-[100%] md:w-[100%] lg:w-[100%] 2xl:w-[90%] mx-auto z-40 flex flex-col items-center justify-center gap-[1rem] new-sm:h-max md:h-[10rem] md:mt-[1rem] py-[0.5rem] ${isScrollingUp && "sticky top-[1rem] bg-[#FFF6F4] md:border-[#56A430] md:border-[1.6px] md:rounded-[1rem] transition-all md:duration-300"}`}
      >
