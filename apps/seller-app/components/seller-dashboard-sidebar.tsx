  ...
  return (
    <div className="w-[20.625rem] h-[100%] bg-custom-bg rounded-[1.88rem] flex-col border-[1px]">
      ...
      <div className="h-max flex-col">
        ...
        <div className="w-[18.9375rem] h-[4.0625rem] rounded-[24px] flex justify-start items-center m-[1rem] bg-[#fff] overflow-hidden">
          <SellerDashboardSiteLogo />
        </div>

        {/* Following div consist of Sidebar Menu Section */}
        <ul className="mt-[0.5rem] text-[#fff] pl-[1.5rem]">
      ...
      <div className="relative mt-[6.5rem] w-[20.625rem] border-t-[2px] border-[#FFFFFF8C] flex flex-col items-center">
        <div className="absolute top-[-6rem] rounded-[1.5rem] w-[18.9375rem] h-[11.0625rem] py-[1.2rem] px-[2rem] bg-[#fff] border-[2px] border-[#697F75]">
        ...
        <div className="z-10 w-[18.9375rem] h-[4.0625rem] rounded-[1.5rem] flex justify-around items-center m-[1rem] bg-[#fff] border-[2px] border-[#697F75]">
          <div className="w-[2.625rem] h-[2.625rem] rounded-full relative overflow-hidden">
            <Image
              src={
          ...
          <div className="flex items-center gap-[1rem]">
            <div className="font-medium capitalize">
              <h1 className="text-[#123524] text-[1.22688rem]">
                Evergreen Gardens
              </h1>
