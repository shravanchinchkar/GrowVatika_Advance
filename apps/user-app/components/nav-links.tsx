  ...
  return (
    <div
      className={
        linkNumber === "1"
          ...
          : "flex flex-col w-[100%] h-[100%] uppercase justify-center items-center transition-all duration-300 ease-in-out hover:bg-[#8FAA83] hover:text-lg  overflow-hidden cursor-pointer"
      }
    ...
    >
      ...
      {linkName === "Collections" ? (
        <div
          className={`absolute lg:w-[7.9rem] xl:w-[11.49rem] h-[8rem] top-full lg:left-[7.9rem] xl:left-[11.57rem] bg-[#649173] rounded-b-lg shadow-lg transition-none duration-300 overflow-hidden${
